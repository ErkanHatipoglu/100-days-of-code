...
PLAYER_DIMENSIONS = (20, 20)  # Dimensions of player segments
PLAYER_SHAPE = "turtle"
UP = 90
...
NUMBER_OF_CARS = 25
CAR_SHAPE = "square"
WIDTH_STRETCH_CONSTANT = 1
LENGTH_STRETCH_CONSTANT = 2
LEFT = 180
CAR_MIN_STARTING_X_POS = 300
CAR_MIN_STARTING_Y_POS = -270
